...
// ============================================================
void SIM800::httpParams(CmdType type, const char* str) {
    outBuilder(type, str, P("HTTPPARA"));
    print(ioBuffer);
}

// ============================================================
void SIM800::httpData(CmdType type, const char* str) {
    outBuilder(type, str, P("HTTPDATA"));
    print(ioBuffer);
}

// ============================================================
void SIM800::httpAction(CmdType type, const char* str) {
    outBuilder(type, str, P("HTTPACTION"));
    print(ioBuffer);
}

// ============================================================
void SIM800::httpRead(CmdType type, const char* str) {
