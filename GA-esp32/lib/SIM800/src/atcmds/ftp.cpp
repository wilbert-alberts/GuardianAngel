...
// ============================================================
void SIM800::ftpPort(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPORT"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpMode(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPMODE"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpDataType(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPTYPE"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpPutMode(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPUTOPT"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpBearerID(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPCID"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpResume(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPREST"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpServerAddr(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPSERV"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpUsername(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPUN"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpPassword(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPW"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpDownName(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPGETNAME"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpDownPath(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPGETPATH"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpUpName(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPUTNAME"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpUpPath(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPUTPATH"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpGetFile(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPGET"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpPutFile(CmdType type, const char* str) {
...
// ============================================================
void SIM800::ftpExtPutfile(CmdType type, const char* str) {
...
// ============================================================
void SIM800::ftpListFiles(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPLIST"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpGetToFS(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPGETTOFS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpPutFromFS(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPPUTFRMFS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpExtGetfile(CmdType type, const char* str) {
    outBuilder(type, str, P("FTPEXTGET"));
    print(ioBuffer);
}

// ============================================================
void SIM800::ftpPutFromRAM(CmdType type, const char* str) {
