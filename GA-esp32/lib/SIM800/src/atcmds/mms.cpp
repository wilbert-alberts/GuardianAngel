...
// ============================================================
void SIM800::mmsCenterUrl(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSCURL"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsProxy(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSPROTO"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsNetwork(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSCID"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsCfgSend(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSSENDCFG"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsEdit(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSEDIT"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsDownFile(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSDOWN"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsDelFile(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSDELFILE"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsSend(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSSEND"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsAddRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSRECP"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsAddCopyRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSCC"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsAddBccRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSBCC"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsDelRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSDELRECP"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsDelCopyRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSDELCC"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsDelBccRecp(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSDELBCC"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsGet(CmdType type, const char* str) {
...
// ============================================================
void SIM800::mmsRead(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSREAD"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsReadPush(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSRDPUSH"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsUserAgent(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSUA"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsUserProfile(CmdType type, const char* str) {
    outBuilder(type, str, P("CMMSPROFILE"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mmsTimeout(CmdType type, const char* str) {
