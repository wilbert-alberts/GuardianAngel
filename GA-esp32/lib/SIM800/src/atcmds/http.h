...
public:
    ...
    /* AT+HTTPPARA     257 */    void httpParams  (CmdType, const char* = "");
    /* AT+HTTPDATA     259 */    void httpData    (CmdType, const char* = "");
    /* AT+HTTPACTION   259 */    void httpAction  (CmdType, const char* = "");
    /* AT+HTTPREAD     261 */    void httpRead    (CmdType, const char* = "");
