...
#define PSTR(s) (s)
#define NODEBUG                                   // Uncomment this line to enable Serial Monitor output from this library.
...
#define DEF_BUFFER_SIZE 1000                    // Size of the char[] ioBuffer which is used to buffer outgoing commands and incoming replies.
