...
// ============================================================
void SIM800::begin(unsigned long speed, uint32_t config, int8_t rxPin, int8_t txPin) {                       // Initializes SoftwareSerial object with the baudrate provided by the user.
    ...
    #endif
    simCom.begin(speed, config, rxPin, txPin);                                        // Calls SoftwareSerial method "begin" either with default baudrate or user provided baudrate.
}
