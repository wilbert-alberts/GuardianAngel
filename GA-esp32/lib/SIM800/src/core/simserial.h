...
public:
    void begin(unsigned long speed, uint32_t config=SERIAL_8N1, int8_t rxPin=-1, int8_t txPin=-1);      // Begins SoftwareSerial with user provided baudrate or default value defined in the SIM800.h file.
